...
def ragel(rlfname):
    ...
    if os.path.isfile(cfname):
        ...
        if rlmt < cmt:
            return
    sp.check_call(["ragel", "-G2", "-C", "-o", cfname, rlfname])
...
def run_setup(with_binary):
    ...
    setup(
        ...
        url = "http://github.com/davisp/simplehttp",
        download_url = "http://github.com/davisp/simplehttp.git",
        zip_safe = False,
